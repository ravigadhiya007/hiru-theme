...
<div class="wp-block-cover alignfull has-parallax" style="min-height:250px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<h1 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Page not Found', 'blok' ); ?></h1>
		<!-- /wp:heading -->
	</div>
</div>
<!-- /wp:cover -->