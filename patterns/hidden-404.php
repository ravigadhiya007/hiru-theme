...
<h4 class="wp-block-heading has-text-align-center heading-404 has-primary-color has-text-color has-link-color" style="font-size:20rem;font-style:normal;font-weight:800;line-height:1"><?php esc_html_e( '404', 'hiru' ); ?></h4>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-text-align-center has-black-color has-text-color has-link-color has-x-large-font-size" style="margin-top:0;font-style:normal;font-weight:700"><?php esc_html_e( 'Page not Found', 'hiru' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'The page you are looking for doesn’t exist or may have been moved. Please check the URL or return to the homepage.', 'hiru' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Back to Home', 'hiru' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->