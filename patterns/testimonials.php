...
<div class="wp-block-group alignwide"><!-- wp:image {"id":929,"width":"auto","height":"64px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|duotone-1"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/quote-left-icon.svg" alt="quote-left-icon" class="wp-image-929" style="width:auto;height:64px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/happy-customer.webp" alt="happy-customer" class="has-border-color has-primary-border-color wp-image-982" style="border-width:4px;border-radius:100%;width:80px"/></figure>
<!-- /wp:image -->
